...
main functions are [`wdpa_fetch()`](reference/wdpa_fetch.md) for
downloading data and [`wdpa_clean()`](reference/wdpa_clean.md) for
cleaning data. For more information, please see the package vignette.
...
information, see [`?wdpa_clean`](reference/wdpa_clean.md).
...
![](reference/figures/README-readme-map-1.png)
