...
# repair any geometry issues, dissolve the border, and reproject to same
# coordinate system as the protected area data
mlt_boundary_data <- mlt_boundary_data %>%
...
* Canada
    + [Conservation Areas Reporting and Tracking System (CARTS)](http://www.ccea.org/carts/)
